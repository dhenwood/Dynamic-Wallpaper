...
Close this repo on your web server. Ensure the video files you wish to use are available and are installed in the /videos folder. You will still need to perform Option 2 above to have the video device launch the web page, but with your own web servers address.
